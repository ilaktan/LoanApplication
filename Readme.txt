...
There are a lot of bugs in the test.
Some bugs in the application
Forename: allows number.
Surname: allows number.
Email address: allows us the invalid email address
Are you over 18?: If I chose the date of Birth under the 18 age the  application allow us chose yes.
Next: If I chose the date of birth under 18 age the application allow us to click the next one
Address Line 1:Allow us invalid address
Town/City: Allow us invalid Town/City
Sort Code: Allow us invalid Sort Code
